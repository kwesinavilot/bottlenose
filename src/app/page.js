      ...
      <main className="container mx-auto px-4 py-0">
        ...
        <section className="flex flex-col items-center justify-center min-h-[70vh] py-16 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="block d-block justify-center items-center mb-2">
              <Button asChild size="lg" className="px-8 py-6 text-lg font-semibold" id="get-started">
                <a href="#get-started">Create Your First Newsletter &rarr;</a>
              </Button>
            </div>
            <span className="block text-center text-slate-500 text-base">(It’s free! No credit card required.)</span>
          </div>
        </section>
